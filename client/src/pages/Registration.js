...
function Registration() {
    ...
    const handleSubmit = async (event) => {
        ...
        if (!form.checkValidity()) {
            ...
            try {
                await axios.post("http://localhost:3001/auth/register", { firstName, lastName, username, password });
            } catch (err) {
    ...
    <div className="container h-100">
        <div className="row d-flex justify-content-center align-items-center">
            <div className="col-12 col-md-9 col-lg-7 col-xl-6">
                <div className="card gradient-custom" style={{ borderRadius: '10px'}}>
                    <div className="card-body p-5">
                        ...
                        <div className='d-flex justify-content-center'>
                            <form id="registration-form"className="needs-validation" data-testid="registration-form" onSubmit={handleSubmit} noValidate>
                                ...
                                <p className="text-center text-muted mt-5">Have an account already? <Link to="/login"><u>Login here</u></Link></p>
